...
// Date : February 2017
{
    public partial class frm_Main : Form
    {
        ...
        private void btn_CM_to_Inches_Click(object sender, EventArgs e)
        {
            ...
            if (count >= 5)
            {
                MessageBox.Show("You have made 5 conversions CM to Inches");
            }
            else
            {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (count >= 5)
            {
                MessageBox.Show("You have made 5 conversions CELCIUS to FAH");
            }
            else
            {
                if (!double.TryParse(txt_UnitOfMeasure.Text, out dbl_UofM))
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (count >= 5)
            {
                MessageBox.Show("NO sir-ey! KM to miles");
            }
            else
            {
                if (!double.TryParse(txt_UnitOfMeasure.Text, out dbl_UofM))
        ...
        private void btn_M_to_Feet_Click(object sender, EventArgs e)
        {
            ...
            if (count >= 5)
            {
                MessageBox.Show("Nope! Said the engineer. Meters to Feet.");
            }
            else
            {
                if (!double.TryParse(txt_UnitOfMeasure.Text, out dbl_UofM))
